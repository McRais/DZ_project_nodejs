...
import {AuthWithBasicAccessMiddleware} from "../middlewares/auth-with-basic-access-middleware";
...
//delete blog
blogsRoute.delete('/:id',AuthWithBasicAccessMiddleware, async (req:Request, res:Response) =>{
...
//post blog
blogsRoute.post("/",AuthWithBasicAccessMiddleware, blogCreateUpdateBodyValidation(), async (req:RequestWithBody<{name:string, description:string, websiteUrl:string}>, res:Response) =>{
...
//update blog
blogsRoute.put("/:id",AuthWithBasicAccessMiddleware, blogCreateUpdateBodyValidation(), async (req:RequestWithBodyAndParams<{id:string},{name:string, description:string, websiteUrl:string}>, res:Response) =>{
...
blogsRoute.post("/:id/posts", AuthWithBasicAccessMiddleware,BlogIdInParamValidation(), postInBlogRouteValidation(), async (req:RequestWithBodyAndParams<{id:string},{title:string, shortDescription:string, content:string}>, res:Response) =>{
