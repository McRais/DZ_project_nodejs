...
import {blogIdValidation, blogBodyValidation} from "../validators/validator-blogs";
...
blogsRoute.post("/",authMiddleware, blogIdValidation, async (req:RequestWithBody<{name:string, description:string, websiteUrl:string}>, res:Response) =>{
