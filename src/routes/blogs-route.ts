...
import {blogIdValidation, blogParamsValidation} from "../validators/validator-blogs";
...
blogsRoute.post("/",authMiddleware, blogParamsValidation, async (req:RequestWithBody<{name:string, description:string, websiteUrl:string}>, res:Response) =>{
