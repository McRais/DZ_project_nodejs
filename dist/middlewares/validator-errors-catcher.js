...
exports.blogIdParamValidatorCatcher = exports.validatorErrorsCatcher = void 0;
...
const blogIdParamValidatorCatcher = (req, res, next) => {
    const validationErrors = (0, express_validator_1.validationResult)(req).formatWith((error) => ({
        message: error.msg,
        field: error.type === "field" ? error.path : "field is not found"
    }));
...
exports.blogIdParamValidatorCatcher = blogIdParamValidatorCatcher;
