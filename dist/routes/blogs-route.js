...
exports.blogsRoute.post("/:id/posts", auth_middleware_1.authMiddleware, (0, validator_posts_1.postValidation)(), (0, validator_posts_1.blogIdParamValidation)(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
