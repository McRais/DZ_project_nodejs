...
exports.usersRoute.get('/', auth_by_basic_credentials_middleware_1.AuthByBasicCredentialsMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//create new user
exports.usersRoute.post('/', auth_by_basic_credentials_middleware_1.AuthByBasicCredentialsMiddleware, (0, validator_users_1.userValidator)(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//delete user
exports.usersRoute.delete('/:id', auth_by_basic_credentials_middleware_1.AuthByBasicCredentialsMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
